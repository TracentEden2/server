...
entity.onMobSpawn = function(mob)
    ...
    -- just scale down the base damage by level from BahamutV2
    mob:setMobMod(xi.mobMod.WEAPON_BONUS, 51) -- (lvl 83 + 2) + 51 = 136
    -- gives firaga iv a cast time of ~2 seconds as per retail
    -- note bahamut has a job trait with fast cast of 15% so 75% total
    mob:setMod(xi.mod.UFASTCAST, 60) --x
    -- 425 + str bonus is 475 total attack (currently 495 UPDATE!!)
...
local megaflareHPPs = { 90, 80, 70, 60, 50, 40, 30, 20 }
